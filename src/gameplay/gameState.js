...
const ITEMS = [
	{
		...
		meaning:
			"Nấm Pha Lê chứa nguồn năng lượng phát quang cổ đại. Khi được đặt về đúng vị trí trên Cây Đại Thụ, nó sẽ thắp lại ánh sáng đom đóm đầu tiên cho khu rừng — xua tan bóng tối bao phủ tầng thấp.",
	...
	},
	{
		...
		meaning:
			"Ấm Trà Vàng là bảo vật của Vị Tiên Rừng. Bên trong chứa giọt sương thần kỳ có thể hồi sinh mọi cây cối đang héo úa. Khi rót lên rễ Đại Thụ, dòng nhựa sống sẽ lại chảy khắp khu rừng.",
	...
	},
	{
		...
		meaning:
			"Bánh Xe Cổ là trục xoay của Thời Gian Rừng. Khi lời nguyền phá hủy nó, dòng thời gian trong rừng bắt đầu chạy ngược, khiến muôn loài rơi vào hỗn loạn. Khôi phục nó sẽ ổn định lại nhịp sống tự nhiên.",
	...
	},
	{
		...
		meaning:
			"Hộp Kho Báu lưu giữ ký ức ngàn năm của khu rừng — từ tiếng chim hót đầu tiên đến lời thì thầm của gió. Mở ra nó sẽ giúp muôn loài nhớ lại bản ngã, thoát khỏi sự mê muội do lời nguyền gây ra.",
	...
	},
	{
		...
		meaning:
			"Viên Ngọc Rừng là trái tim năng lượng của Cây Đại Thụ Vĩnh Hằng. Đây là bảo vật cuối cùng và mạnh nhất — khi được đặt lại vào lõi cây, toàn bộ lời nguyền sẽ bị phá giải hoàn toàn, mang lại sự bình yên vĩnh cửu.",
...
export function setPaused(state) {
	isPaused = state;
	document.dispatchEvent(
		new CustomEvent(isPaused ? "gamePaused" : "gameResumed"),
	);
}
